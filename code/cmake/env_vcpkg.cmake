...
if(EXISTS "${CMAKE_SOURCE_DIR}/vcpkg.json")
    ...
    if(NOT VCPKG_INSTALL_RESULT EQUAL 0)
        ...
        file(GLOB VCPKG_INSTALLED_ALL DIRECTORY "${CMAKE_SOURCE_DIR}/vcpkg_installed/*" LIST_DIRECTORIES true)
        FOREACH (ITEM ${VCPKG_INSTALLED_ALL})
            if(IS_DIRECTORY ${ITEM} AND NOT ITEM STREQUAL "${CMAKE_SOURCE_DIR}/vcpkg_installed/vcpkg")
